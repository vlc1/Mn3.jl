...
Depuis le site <https://julialang.org/downloads/>, télécharger la dernière version stable, à savoir Julia 1.6.* en sélectionnant le bon système d'exploitation (Linux x86, Mac, Windows...).
...
Dans votre notebook `Pluto`, créer quelques cellules pour visualiser la fonction (ou toute fonction de votre choix), par exemple ``\exp``.
